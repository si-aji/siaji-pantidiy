                    ...
                    <div class="card-body">
                        <div class="form-group" id="form-category_id">
                            ...
                            <select class="form-control select2 @error('category_id') is-invalid @enderror" name="category_id" id="field-category_id">
                                <option value="null" {{ $post->category_id == 'null' ? 'selected' : '' }}>- Select a Category -</option>
                                @foreach ($category as $item)
                                <option value="{{ $item->id }}" {{ $post->category_id == $item->id ? 'selected' : '' }}>{{ $item->category_title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" type="checkbox" name="post_shareable" value="true" id="field-post_shareable" {{ $post->post_shareable == true ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" type="checkbox" name="post_commentable" value="true" id="field-post_commentable" {{ $post->post_commentable == true ? 'checked' : '' }}>
...
<script>
    ...
    $('#field-post_published').datetimepicker({
        ...
        {!! $post->post_status == 'published' ? 'defaultDate: "'.$post->post_published.'"' : '' !!}
    });
