...
@section('content')
<form class="card" action="{{ route('dashboard.event.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="row">
                <div class="col-12 col-lg-4">
                    <div class="sa-preview">
                        <button type="button" class="btn btn-sm btn-danger d-block mb-2 mx-auto btn-preview_remove" onclick="removePreview($(this),  '', 'event_thumbnail')" disabled>Reset Preview</button>
                        <img class="img-responsive img-preview mx-auto">
                    </div>
                </div>

                <div class="col-12 col-lg-8">
                    <div class="custom-file">
                        <input type="file" class="custom-file-input @error('event_thumbnail') is-invalid @enderror" name="event_thumbnail" id="customFile" onchange="generatePreview($(this), 'event_thumbnail')">
