...
@section('content')
<form class="card" action="{{ route('dashboard.panti.liputan.update', $liputan->id) }}" method="POST" id="liputan-form" enctype="multipart/form-data">
    @csrf
    @method('PUT')
        ...
        <div class="card" id="form-panti_gallery">
            ...
            <div class="card-body">
                <div class="row" id="panti-body">
                    @foreach($liputan->pantiLiputanGallery as $key => $value)
                            ...
                            <div class="card-body">
                                <div class="form-group" id="form-panti_image_{{ $gallery_start }}">
                                    <div class="sa-preview mb-2">
                                        ...
                                        <img class="img-responsive img-preview" src="{{ asset('img/panti/liputan'.'/'.$value->gallery_fullname) }}">
                                    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group" id="form-liputan_content">
                    <textarea id="field-liputan_content" name="liputan_content" class="liputan_content @error('liputan_content') is-invalid @enderror">{!! $liputan->liputan_content !!}</textarea>
...
<script>
    $(document).ready(function(){
        ...
        // Add more Gallery
        let gallery_start = {{ $liputan->pantiLiputanGallery()->exists() ? $gallery_start : '0' }};
        let gallery_wrap = $("#form-panti_gallery");
        let gallery_add = $("#panti-gallery_add");
        let gallery_file = 'gallery_file';
        let gallery_length = {{ $liputan->pantiLiputanGallery()->exists() ? $gallery_start : '0' }};
